...
import com.Elysia.elysia.screen.slot.ModFuelSlot;
import com.Elysia.elysia.screen.slot.ModResultSlot;
...
public class ToasterMenu extends AbstractContainerMenu {
    ...
    public ToasterMenu(int windowId, Inventory inv, BlockEntity entity, ContainerData data) {
    	...
    	this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
    		...
    		this.addSlot(new SlotItemHandler(handler, 0, 18, 50));
    		this.addSlot(new ModResultSlot(handler, 0, 18, 50));
    	});
