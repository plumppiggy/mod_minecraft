...
public class Registration {
	...
	public static final RegistryObject<Block> BRUV_ORE = BLOCKS.register("bruv_ore", () -> new Block(BLOCK_PROPERTIES));
	public static final RegistryObject<Item> BRUV_ORE_ITEM = fromBlock(BRUV_ORE);
	...
	public static final RegistryObject<Item> SHIV = ITEMS.register("shiv", () -> new SwordItem(Tiers.DIAMOND, 5, 2f, new Item.Properties().tab(ModSetup.ITEM_GROUP)));
